...
echo -e "$green.........................................................."$NC
echo -e "               Autoscript Mod By arlanstore"$NC | lolcat
echo -e "                    CONTACT TELEGRAM"$NC | lolcat
echo -e "                       @arlanstore"$NC | lolcat
echo -e "$green.........................................................."$NC
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/arlanstore/izinvps/ipuk/ipe | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mAUTOSCRIPT SUKSES..\e[0m"
        sleep 5
    else
    echo -e "\e[31mScript Anda Telah Expired !!\e[0m";
    echo -e "\e[31mTolong Renew Dengan Owner Script @arlanstore\e[0m"
    exit 0
    fi
}
IZIN=$(curl https://raw.githubusercontent.com/arlanstore/izinvps/ipuk/ipe | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
clear
CLNAME=$(curl https://raw.githubusercontent.com/arlanstore/izinvps/ipuk/ipe | grep $MYIP | awk '{print $2}')
if [ $MYIP = $CLNAME ]; then
echo ""
fi
clear
...
CDNF="https://raw.githubusercontent.com/arlanstore/abc/ipuk"
